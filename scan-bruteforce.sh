...
amass enum -v -df $DOMAINFILE -config config-bruteforce.ini -o $PROGNAME.txt -nf $KNOWNFILE
#amass enum -v -df $DOMAINFILE -config config-bruteforce.ini -o $PROGNAME.txt -nf $KNOWNFILE -blf $BLFILE
