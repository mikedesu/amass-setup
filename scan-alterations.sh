...
amass enum -v -df $DOMAINFILE -config config-alterations.ini -o $PROGNAME.txt -nf $KNOWNFILE
#amass enum -v -df $DOMAINFILE -config config.ini -o $PROGNAME.txt -nf $KNOWNFILE -blf $BLFILE
